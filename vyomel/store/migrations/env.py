...
Runs migrations against the async engine so the same driver and URL are used in
migrations, application code, and tests. Divergence there is a classic source
of "works locally, fails in CI".
"""
...
from vyomel.store.models import Base
