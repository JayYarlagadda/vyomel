...
from vyomel.core.ids import canonical_json, content_hash
from vyomel.core.logging import get_logger, redact
from vyomel.core.types import Capability
from vyomel.store.models import AUDIT_ID_SEQ, AuditLog
...
class AuditTrail:
    ...
    async def verify(self, session: AsyncSession, *, start_id: int | None = None) -> ChainReport:
        ...
        the row immediately before it. ``vyomel audit verify`` walks everything;
