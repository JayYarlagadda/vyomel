...
from vyomel.runtime.dag import ActionNode, reverse_topo
        ...
        *,
        ...
        for action_id in order:
            ...
            try:
                ...
                log.exception(
                    "vyomel.runtime.compensate_failed", action_id=action.id, tool=action.tool
                )
                failed.append(
                    CompensationFailure(
                        action_id=action.id,
