...
from vyomel.core.ids import idempotency_key
from vyomel.core.logging import get_logger
from vyomel.core.types import ActionStatus, ApprovalStatus, Trust
from vyomel.runtime.gate import PolicyGate
from vyomel.security.approvals import ApprovalService, parameter_hash
...
from vyomel.store.models import Action, Approval
...
class ApprovalWorkflow:
    ...
    async def _rewrite(self, action: Action, modified_parameters: dict[str, Any]) -> None:
        ...
        if classification.level > action.capability_level:
            log.info(
                "vyomel.security.modification_escalated",
                action_id=action.id,
