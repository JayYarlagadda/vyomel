...
Lives in orchestrator because it wires planner plans with runtime scheduler/worker.
"""
...
from vyomel.orchestrator.runtime import get_registry, make_scheduler, make_worker
from vyomel.orchestrator.tasks import TaskService
from vyomel.planner.longrun import build_research_plan
from vyomel.runtime.chaos import ResearchAudit, abandon_running_action, audit_research_task
