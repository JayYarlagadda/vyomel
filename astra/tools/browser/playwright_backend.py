"""Optional Playwright backend (requires ``pip install astra[browser]``)."""
...
from astra.tools.browser.resolve import build_a11y_tree, dom_excerpt, parse_dom
from astra.tools.browser.session import fixtures_dir
from astra.tools.browser.types import ElementRef, PageSnapshot, Target
...
class PlaywrightSession:
    ...
    async def _ensure(self) -> Any:
        ...
        try:
            ...
            raise ToolError(
                "playwright is not installed; use ASTRA_BROWSER_BACKEND=fixture",
